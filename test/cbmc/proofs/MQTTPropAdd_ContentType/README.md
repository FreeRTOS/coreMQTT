MQTTPropAdd_ContentType proof
=============================

This directory contains a memory safety proof for MQTTPropAdd_ContentType.

MQTTPropAdd_ContentType is a public entry point into the file-local addPropUtf8
