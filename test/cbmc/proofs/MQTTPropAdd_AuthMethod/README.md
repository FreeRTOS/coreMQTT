MQTTPropAdd_AuthMethod proof
============================

This directory contains a memory safety proof for MQTTPropAdd_AuthMethod.

MQTTPropAdd_AuthMethod is a public entry point into the file-local addPropUtf8
