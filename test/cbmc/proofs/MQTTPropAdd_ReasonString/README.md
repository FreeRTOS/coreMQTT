MQTTPropAdd_ReasonString proof
==============================

This directory contains a memory safety proof for MQTTPropAdd_ReasonString.

MQTTPropAdd_ReasonString is the cleanest public entry point into the file-local
addPropUtf8 helper, which serializes a UTF-8 string property into the property
builder buffer as:
