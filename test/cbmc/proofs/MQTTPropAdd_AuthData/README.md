MQTTPropAdd_AuthData proof
==========================

This directory contains a memory safety proof for MQTTPropAdd_AuthData.

MQTTPropAdd_AuthData is a public entry point into the file-local addPropUtf8
