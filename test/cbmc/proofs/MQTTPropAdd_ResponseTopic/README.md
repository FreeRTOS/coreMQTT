MQTTPropAdd_ResponseTopic proof
===============================

This directory contains a memory safety proof for MQTTPropAdd_ResponseTopic.

MQTTPropAdd_ResponseTopic is a public entry point into the file-local addPropUtf8
