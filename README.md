...
This repository contains the coreMQTT Client library that has been optimized for a low memory footprint.  This repository is submoduled into [AWS Reference Integrations](https://github.com/aws/amazon-freertos) and [AWS IoT Device SDK for Embedded C](https://github.com/aws/aws-iot-device-sdk-embedded-C) and is maintained as part of the FreeRTOS project.  The coreMQTT Client library implements the complete [MQTT 3.1.1](http://docs.oasis-open.org/mqtt/mqtt/v3.1.1/mqtt-v3.1.1.html) standard.  It has no dependencies on any additional libraries other than the standard C library and a customer-implemented network transport interface. 
